...
------------ | ------------- | ------------- | -------------
*AWSS3Api* | [**get_signed_s3_url**](docs/AWSS3Api.md#get_signed_s3_url) | **GET** /amazon/s3/signedposturl | Get a signed S3 URL
...
*GamificationTriviaApi* | [**get_question_tags1**](docs/GamificationTriviaApi.md#get_question_tags1) | **GET** /trivia/tags | List and search tags by the beginning of the string
...
*InvoicesApi* | [**list_ful_fillment_statuses**](docs/InvoicesApi.md#list_ful_fillment_statuses) | **GET** /invoices/fulfillment-statuses | Lists available fulfillment statuses
*InvoicesApi* | [**list_payment_statuses**](docs/InvoicesApi.md#list_payment_statuses) | **GET** /invoices/payment-statuses | Lists available payment statuses
...
*LocationsApi* | [**get_cities**](docs/LocationsApi.md#get_cities) | **GET** /location/countries/{country_code_iso3}/states/{state_code}/cities | Get a list of a state&#39;s cities
*LocationsApi* | [**get_countries1**](docs/LocationsApi.md#get_countries1) | **GET** /location/countries | Get a list of countries
*LocationsApi* | [**get_countries2**](docs/LocationsApi.md#get_countries2) | **GET** /location/countries/{country_code_iso3}/states | Get a list of a country&#39;s states
...
*StoreShoppingCartsApi* | [**get_countries**](docs/StoreShoppingCartsApi.md#get_countries) | **GET** /carts/{id}/countries | Get the list of available shipping countries per vendor
...
*UsersInventoryApi* | [**get_user_inventory1**](docs/UsersInventoryApi.md#get_user_inventory1) | **GET** /users/{id}/inventory | List the user inventory entries for a given user
...
*UsersInventoryApi* | [**get_user_inventory_log1**](docs/UsersInventoryApi.md#get_user_inventory_log1) | **PUT** /users/{user_id}/inventory/{id}/expires | Set the expiration date
...
*UtilMaintenanceApi* | [**update_maintenance**](docs/UtilMaintenanceApi.md#update_maintenance) | **POST** /maintenance | Set current maintenance info
*UtilMaintenanceApi* | [**update_maintenance1**](docs/UtilMaintenanceApi.md#update_maintenance1) | **PUT** /maintenance | Set current maintenance info
