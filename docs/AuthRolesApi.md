...
# **set_client_roles**
> set_client_roles(client_key, roles_list=roles_list)
...
try: 
    # Set roles for a client
    api_instance.set_client_roles(client_key, roles_list=roles_list)
except ApiException as e:
...
> set_permissions_for_role(role, permissions_list=permissions_list)
...
try: 
    # Set permissions for a role
    api_instance.set_permissions_for_role(role, permissions_list=permissions_list)
except ApiException as e:
...
# **set_user_roles**
> set_user_roles(user_id, roles_list=roles_list)
...
try: 
    # Set roles for a user
    api_instance.set_user_roles(user_id, roles_list=roles_list)
except ApiException as e:
...
# **update_role**
> update_role(role, role_resource=role_resource)
...
try: 
    # Update a role
    api_instance.update_role(role, role_resource=role_resource)
except ApiException as e:
