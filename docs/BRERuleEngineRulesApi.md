...
# **get_rules_using_get**
> PageBreRule get_rules_using_get(filter_name=filter_name, filter_enabled=filter_enabled, filter_system=filter_system, filter_trigger=filter_trigger, filter_action=filter_action, filter_condition=filter_condition, size=size, page=page)
