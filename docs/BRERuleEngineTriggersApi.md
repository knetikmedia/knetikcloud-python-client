...
# **update_bre_trigger**
> update_bre_trigger(event_name, bre_trigger_resource=bre_trigger_resource)
...
try: 
    # Update a trigger
    api_instance.update_bre_trigger(event_name, bre_trigger_resource=bre_trigger_resource)
except ApiException as e:
