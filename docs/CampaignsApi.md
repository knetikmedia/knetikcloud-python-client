...
# **update_campaign**
> update_campaign(id, campaign_resource=campaign_resource)
...
try: 
    # Update a campaign
    api_instance.update_campaign(id, campaign_resource=campaign_resource)
except ApiException as e:
...
> update_campaign_template(id, campaign_template_resource=campaign_template_resource)
...
try: 
    # Update an campaign template
    api_instance.update_campaign_template(id, campaign_template_resource=campaign_template_resource)
except ApiException as e:
