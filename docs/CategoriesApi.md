...
# **update_category**
> update_category(id, category=category)
...
try: 
    # Update an existing category
    api_instance.update_category(id, category=category)
except ApiException as e:
...
> update_category_template(id, template=template)
...
try: 
    # Update a category template
    api_instance.update_category_template(id, template=template)
except ApiException as e:
