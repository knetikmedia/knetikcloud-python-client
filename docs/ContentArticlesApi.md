...
# **update_article**
> update_article(id, article_resource=article_resource)
...
try: 
    # Update an existing article
    api_instance.update_article(id, article_resource=article_resource)
except ApiException as e:
...
> update_article_template(id, article_template_resource=article_template_resource)
...
try: 
    # Update an article template
    api_instance.update_article_template(id, article_template_resource=article_template_resource)
except ApiException as e:
