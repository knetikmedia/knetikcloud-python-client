...
# **update_poll**
> update_poll(id, poll_resource=poll_resource)
...
try: 
    # Update an existing poll
    api_instance.update_poll(id, poll_resource=poll_resource)
except ApiException as e:
...
> update_poll_template(id, poll_template_resource=poll_template_resource)
...
try: 
    # Update a poll template
    api_instance.update_poll_template(id, poll_template_resource=poll_template_resource)
except ApiException as e:
