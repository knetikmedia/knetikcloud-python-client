...
[**get_available_triggers_using_get**](GamificationAchievementsApi.md#get_available_triggers_using_get) | **GET** /achievements/triggers | Get the list of triggers that can be used to trigger achievement progress update.
...
> PageTemplateResource get_achievement_templates_using_get(size=size, page=page, order=order)
...
> PageAchievementDefinitionResource get_achievements_using_get(filter_tagset=filter_tagset, filter_name=filter_name, filter_hidden=filter_hidden, size=size, page=page, order=order)
...
try: 
    # Get all achievement definitions in the system
    api_response = api_instance.get_achievements_using_get(filter_tagset=filter_tagset, filter_name=filter_name, filter_hidden=filter_hidden, size=size, page=page, order=order)
    pprint(api_response)
except ApiException as e:
...
> PageUserAchievementResource get_all_user_progress_for_achievement_using_get(achievement_name, filter_achievement_tagset=filter_achievement_tagset, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
...
try: 
    # Retrieve progress on a given achievement for all users
    api_response = api_instance.get_all_user_progress_for_achievement_using_get(achievement_name, filter_achievement_tagset=filter_achievement_tagset, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
    pprint(api_response)
except ApiException as e:
...
> PageUserAchievementResource get_all_user_progress_using_get(filter_achievement_tagset=filter_achievement_tagset, filter_achievement_name=filter_achievement_name, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
...
try: 
    # Retrieve progress on achievements for all users
    api_response = api_instance.get_all_user_progress_using_get(filter_achievement_tagset=filter_achievement_tagset, filter_achievement_name=filter_achievement_name, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
    pprint(api_response)
except ApiException as e:
...
> UserAchievementResource get_user_progress_for_achievement_using_get(user_id, achievement_name)
...
> PageUserAchievementResource get_user_progress_using_get(user_id, filter_achievement_tagset=filter_achievement_tagset, filter_achievement_name=filter_achievement_name, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
...
try: 
    # Retrieve progress on achievements for a given user
    api_response = api_instance.get_user_progress_using_get(user_id, filter_achievement_tagset=filter_achievement_tagset, filter_achievement_name=filter_achievement_name, filter_achievement_hidden=filter_achievement_hidden, size=size, page=page)
    pprint(api_response)
except ApiException as e:
...
> UserAchievementResource update_progress_using_put(user_id, achievement_name, request=request)
