...
[**get_question_tags1**](GamificationTriviaApi.md#get_question_tags1) | **GET** /trivia/tags | List and search tags by the beginning of the string
...
# **get_question_tags1**
> Collectionstring get_question_tags1(filter_search=filter_search, filter_category=filter_category, filter_import_id=filter_import_id)
...
try: 
    # List and search tags by the beginning of the string
    api_response = api_instance.get_question_tags1(filter_search=filter_search, filter_category=filter_category, filter_import_id=filter_import_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling GamificationTriviaApi->get_question_tags1: %s\n" % e)
```
...
# **get_questions**
> PageResourceQuestionResource get_questions(size=size, page=page, order=order, filter_search=filter_search, filter_idset=filter_idset, filter_category=filter_category, filter_tagset=filter_tagset, filter_type=filter_type, filter_published=filter_published, filter_import_id=filter_import_id)
...
try: 
    # List and search questions
    api_response = api_instance.get_questions(size=size, page=page, order=order, filter_search=filter_search, filter_idset=filter_idset, filter_category=filter_category, filter_tagset=filter_tagset, filter_type=filter_type, filter_published=filter_published, filter_import_id=filter_import_id)
    pprint(api_response)
except ApiException as e:
...
> update_question_template(id, question_template_resource=question_template_resource)
...
try: 
    # Update a question template
    api_instance.update_question_template(id, question_template_resource=question_template_resource)
except ApiException as e:
