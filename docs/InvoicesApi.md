...
# **get_invoices**
> PageResourceInvoiceResource get_invoices(filter_user=filter_user, filter_email=filter_email, filter_fulfillment_status=filter_fulfillment_status, filter_payment_status=filter_payment_status, filter_item_name=filter_item_name, filter_created_date=filter_created_date, size=size, page=page, order=order)
...
try: 
    # Retrieve invoices
    api_response = api_instance.get_invoices(filter_user=filter_user, filter_email=filter_email, filter_fulfillment_status=filter_fulfillment_status, filter_payment_status=filter_payment_status, filter_item_name=filter_item_name, filter_created_date=filter_created_date, size=size, page=page, order=order)
    pprint(api_response)
except ApiException as e:
...
> list[str] list_ful_fillment_statuses()
...
try: 
    # Lists available fulfillment statuses
    api_response = api_instance.list_ful_fillment_statuses()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling InvoicesApi->list_ful_fillment_statuses: %s\n" % e)
```
...
> list[str] list_payment_statuses()
...
try: 
    # Lists available payment statuses
    api_response = api_instance.list_payment_statuses()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling InvoicesApi->list_payment_statuses: %s\n" % e)
```
