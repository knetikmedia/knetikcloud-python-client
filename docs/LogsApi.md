...
> PageBreEventLog get_events_logs_using_get(filter_start_date=filter_start_date, filter_event_name=filter_event_name, size=size, page=page, order=order)
...
> PageForwardLog get_forward_logs_using_get(filter_start_date=filter_start_date, filter_end_date=filter_end_date, filter_status_code=filter_status_code, size=size, page=page, order=order)
...
> PageUserActionLog get_user_logs_using_get1(filter_user=filter_user, filter_action_name=filter_action_name, size=size, page=page)
