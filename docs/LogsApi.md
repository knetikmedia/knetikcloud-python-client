...
try: 
    # Returns a list of BRE event log entries
    api_response = api_instance.get_bre_event_logs(filter_start_date=filter_start_date, filter_event_name=filter_event_name, size=size, page=page, order=order)
    pprint(api_response)
except ApiException as e:
...
try: 
    # Returns a page of user logs entries
    api_response = api_instance.get_user_logs(filter_user=filter_user, filter_action_name=filter_action_name, size=size, page=page)
    pprint(api_response)
except ApiException as e:
