...
> update_artist_template(id, artist_template_resource=artist_template_resource)
...
try: 
    # Update an artist template
    api_instance.update_artist_template(id, artist_template_resource=artist_template_resource)
except ApiException as e:
