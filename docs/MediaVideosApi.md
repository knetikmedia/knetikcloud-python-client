...
[**delete_relationship_using_delete**](MediaVideosApi.md#delete_relationship_using_delete) | **DELETE** /media/videos/{video_id}/related/{id} | Delete a video&#39;s relationship
...
[**update_relationship_using_put**](MediaVideosApi.md#update_relationship_using_put) | **PUT** /media/videos/{video_id}/related/{id}/relationship_details | Update a video&#39;s relationship details
...
> delete_relationship_using_delete(video_id, id)
...
try: 
    # Delete a video's relationship
    api_instance.delete_relationship_using_delete(video_id, id)
except ApiException as e:
    print("Exception when calling MediaVideosApi->delete_relationship_using_delete: %s\n" % e)
```
...
> PageCommentResource get_comments_using_get1(video_id, size=size, page=page)
...
> PageDispositionResource get_dispositions_using_get1(video_id, size=size, page=page)
...
> PageVideoRelationshipResource get_related_using_get(video_id, size=size, page=page)
...
> PageVideoResource get_user_videos_using_get(user_id, exclude_flagged=exclude_flagged, size=size, page=page)
...
> update_relationship_using_put(video_id, relationship_id, details=details)
...
try: 
    # Update a video's relationship details
    api_instance.update_relationship_using_put(video_id, relationship_id, details=details)
except ApiException as e:
    print("Exception when calling MediaVideosApi->update_relationship_using_put: %s\n" % e)
```
