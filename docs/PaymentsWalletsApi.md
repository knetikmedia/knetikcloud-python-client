...
> PageResourceWalletTransactionResource user_transaction_history_using_get(user_id, currency_code, filter_type=filter_type, filter_max_date=filter_max_date, filter_min_date=filter_min_date, filter_sign=filter_sign, size=size, page=page, order=order)
