...
> PageRevenueCountryReportResource executive_revenue_country_sales_using_get(currency_code, start_date=start_date, end_date=end_date, size=size, page=page)
...
> PageRevenueProductReportResource executive_revenue_product_sales_using_get(currency_code, start_date=start_date, end_date=end_date, size=size, page=page)
