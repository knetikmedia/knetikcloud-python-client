# knetik_cloud.RuleEngineGlobalsApi
...
api_instance = knetik_cloud.RuleEngineGlobalsApi(knetik_cloud.ApiClient(configuration))
...
try: 
    ...
    print("Exception when calling RuleEngineGlobalsApi->create_bre_global: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineGlobalsApi->delete_bre_global: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineGlobalsApi->get_bre_global: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineGlobalsApi->get_bre_globals: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineGlobalsApi->update_bre_global: %s\n" % e)
```
