# knetik_cloud.RuleEngineRulesApi
...
api_instance = knetik_cloud.RuleEngineRulesApi(knetik_cloud.ApiClient(configuration))
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->create_bre_rule: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->delete_bre_rule: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->get_bre_expression_as_string: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->get_bre_rule: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->get_bre_rules: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->set_bre_rule: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineRulesApi->update_bre_rule: %s\n" % e)
```
