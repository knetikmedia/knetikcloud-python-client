# knetik_cloud.RuleEngineTriggersApi
...
api_instance = knetik_cloud.RuleEngineTriggersApi(knetik_cloud.ApiClient(configuration))
...
try: 
    ...
    print("Exception when calling RuleEngineTriggersApi->create_bre_trigger: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineTriggersApi->delete_bre_trigger: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineTriggersApi->get_bre_trigger: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineTriggersApi->get_bre_triggers: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling RuleEngineTriggersApi->update_bre_trigger: %s\n" % e)
```
