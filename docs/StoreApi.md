...
try: 
    # Create a store item
    api_response = api_instance.create_store_item(store_item=store_item)
    pprint(api_response)
except ApiException as e:
...
> update_item_template(id, item_template_resource=item_template_resource)
...
try: 
    # Update an item template
    api_instance.update_item_template(id, item_template_resource=item_template_resource)
except ApiException as e:
...
# **update_store_item**
> update_store_item(id, store_item=store_item)
...
try: 
    # Update a store item
    api_instance.update_store_item(id, store_item=store_item)
except ApiException as e:
