...
> ItemTemplateResource create_item_template_using_post(item_template_resource=item_template_resource)
...
item_template_resource = swagger_client.ItemTemplateResource() # ItemTemplateResource | The new item template (optional)
...
> PageItemTemplateResource get_item_templates_using_get(size=size, page=page, order=order)
...
api_instance = swagger_client.StoreApi()
id = 'id_example' # str | The id of the template
item_template_resource = swagger_client.ItemTemplateResource() # ItemTemplateResource | The item template resource object (optional)
