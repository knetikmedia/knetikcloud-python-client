...
[**get_countries**](StoreShoppingCartsApi.md#get_countries) | **GET** /carts/{id}/countries | Get the list of available shipping countries per vendor
...
# **get_countries**
> SampleCountriesResponse get_countries(id)
...
try: 
    # Get the list of available shipping countries per vendor
    api_response = api_instance.get_countries(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StoreShoppingCartsApi->get_countries: %s\n" % e)
```
