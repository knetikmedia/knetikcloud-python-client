...
[**list_billing_reports_using_get**](StoreSubscriptionsApi.md#list_billing_reports_using_get) | **GET** /subscriptions/reports | Get a list of available subscription reports in most recent first order
...
try: 
    ...
    print("Exception when calling StoreSubscriptionsApi->list_billing_reports_using_get: %s\n" % e)
```
