...
# **create_country_tax**
> create_country_tax(tax_resource=tax_resource)
...
try: 
    # Create a country tax
    api_instance.create_country_tax(tax_resource=tax_resource)
...
# **create_state_tax**
> create_state_tax(country_code_iso3, tax_resource=tax_resource)
...
try: 
    # Create a state tax
    api_instance.create_state_tax(country_code_iso3, tax_resource=tax_resource)
except ApiException as e:
...
# **update_country_tax**
> update_country_tax(country_code_iso3, tax_resource=tax_resource)
...
try: 
    # Create or update a tax
    api_instance.update_country_tax(country_code_iso3, tax_resource=tax_resource)
except ApiException as e:
...
# **update_state_tax**
> update_state_tax(country_code_iso3, state_code, tax_resource=tax_resource)
...
try: 
    # Create or update a state tax
    api_instance.update_state_tax(country_code_iso3, state_code, tax_resource=tax_resource)
except ApiException as e:
