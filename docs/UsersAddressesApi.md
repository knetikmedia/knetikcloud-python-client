...
# **update_address**
> update_address(user_id, id, saved_address_resource=saved_address_resource)
...
try: 
    # Update an address
    api_instance.update_address(user_id, id, saved_address_resource=saved_address_resource)
except ApiException as e:
