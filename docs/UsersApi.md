...
> update_user_template(id, user_template_resource=user_template_resource)
...
try: 
    # Update a user template
    api_instance.update_user_template(id, user_template_resource=user_template_resource)
except ApiException as e:
