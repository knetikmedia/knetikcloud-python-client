...
> PageResourceSimpleUserResource get_friends_using_get(user_id, size=size, page=page, order=order)
...
> PageResourceSimpleUserResource get_invites_using_get(user_id, size=size, page=page, order=order)
