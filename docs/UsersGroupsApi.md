...
username = knetik_cloud.GroupMemberResource() # GroupMemberResource | The username of a user to add to the group
...
# **update_groups**
> PageResourceGroupResource update_groups(filter_name=filter_name, filter_unique_name=filter_unique_name, filter_parent=filter_parent, size=size, page=page, order=order)
...
# create an instance of the API class
api_instance = knetik_cloud.UsersGroupsApi()
filter_name = 'filter_name_example' # str | Filter for groups whose name starts with provided string (optional)
...
filter_parent = 'filter_parent_example' # str | Filter for groups whose parent equals provided string (optional)
size = 25 # int | The number of objects returned per page (optional) (default to 25)
page = 1 # int | The number of the page returned, starting with 1 (optional) (default to 1)
...
try: 
    # List and search groups
    api_response = api_instance.update_groups(filter_name=filter_name, filter_unique_name=filter_unique_name, filter_parent=filter_parent, size=size, page=page, order=order)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filter_name** | **str**| Filter for groups whose name starts with provided string | [optional] 
 **filter_unique_name** | **str**| Filter for groups whose unique_name starts with provided string | [optional] 
 **filter_parent** | **str**| Filter for groups whose parent equals provided string | [optional] 
 **size** | **int**| The number of objects returned per page | [optional] [default to 25]
 **page** | **int**| The number of the page returned, starting with 1 | [optional] [default to 1]
