...
> update_group_template(id, group_template_resource=group_template_resource)
...
try: 
    # Update a group template
    api_instance.update_group_template(id, group_template_resource=group_template_resource)
except ApiException as e:
