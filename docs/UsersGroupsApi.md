...
[**delete_group_member_using_delete**](UsersGroupsApi.md#delete_group_member_using_delete) | **DELETE** /users/groups/{unique_name}/members/{user_id} | Removes a user from a group
...
[**delete_group_using_delete**](UsersGroupsApi.md#delete_group_using_delete) | **DELETE** /users/groups/{unique_name} | Removes a group from the system IF no resources are attached to it
[**get_group_list_using_get**](UsersGroupsApi.md#get_group_list_using_get) | **GET** /users/{user_id}/groups | List groups a user is in
[**get_group_member_using_get**](UsersGroupsApi.md#get_group_member_using_get) | **GET** /users/groups/{unique_name}/members/{user_id} | Get a user from a group
...
# **delete_group_member_using_delete**
> delete_group_member_using_delete(unique_name, user_id)
...
try: 
    # Removes a user from a group
    api_instance.delete_group_member_using_delete(unique_name, user_id)
except ApiException as e:
    print("Exception when calling UsersGroupsApi->delete_group_member_using_delete: %s\n" % e)
```
...
> delete_group_using_delete(unique_name)
...
try: 
    # Removes a group from the system IF no resources are attached to it
    api_instance.delete_group_using_delete(unique_name)
except ApiException as e:
...
# **get_group_list_using_get**
> list[str] get_group_list_using_get(user_id)
...
try: 
    # List groups a user is in
    api_response = api_instance.get_group_list_using_get(user_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling UsersGroupsApi->get_group_list_using_get: %s\n" % e)
```
...
# **get_group_member_using_get**
> GroupMemberResource get_group_member_using_get(unique_name, user_id)
...
try: 
    # Get a user from a group
    api_response = api_instance.get_group_member_using_get(unique_name, user_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling UsersGroupsApi->get_group_member_using_get: %s\n" % e)
```
...
> PageResourceTemplateResource get_group_templates_using_get(size=size, page=page, order=order)
...
> PageResourceGroupMemberResource search_groups_using_get(unique_name, size=size, page=page, order=order)
...
> PageResourceGroupResource search_groups_using_get1(size=size, page=page, order=order)
