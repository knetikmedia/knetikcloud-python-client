...
class DevicesApi(object):
    ...
    def create_device_template(self, **kwargs):
        ...
        :param async bool
        :param TemplateResource device_template_resource: The device template resource object
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.create_device_template_with_http_info(**kwargs)
        else:
            (data) = self.create_device_template_with_http_info(**kwargs)
            return data
    ...
    def create_device_template_with_http_info(self, **kwargs):
        ...
        all_params = ['device_template_resource']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_device_template" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        body_params = None
        if 'device_template_resource' in params:
            body_params = params['device_template_resource']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
        ...
        return self.api_client.call_api('/devices/templates', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_device_template(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_device_template_with_http_info(id, **kwargs)
        else:
            (data) = self.delete_device_template_with_http_info(id, **kwargs)
            return data
    ...
    def delete_device_template_with_http_info(self, id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_device_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_device_template`")
        ...
        return self.api_client.call_api('/devices/templates/{id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_device_template(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_device_template_with_http_info(id, **kwargs)
        else:
            (data) = self.get_device_template_with_http_info(id, **kwargs)
            return data
    ...
    def get_device_template_with_http_info(self, id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_device_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_device_template`")
        ...
        return self.api_client.call_api('/devices/templates/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_device_templates(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_device_templates_with_http_info(**kwargs)
        else:
            (data) = self.get_device_templates_with_http_info(**kwargs)
            return data
    ...
    def get_device_templates_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_device_templates" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/devices/templates', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_devices(self, **kwargs):
        ...
        :param str filter_os: Filter for devices with specified OS
        :param str filter_serial: Filter for devices with specified serial
        :param str filter_type: Filter for devices with specified type
        :param str filter_tag: A comma separated list without spaces to filter for devices with specified tags (matches any)
        :param int size: The number of objects returned per page
        :param int page: The number of the page returned, starting with 1
        :param str order: A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
    ...
    def get_devices_with_http_info(self, **kwargs):
        ...
        all_params = ['filter_make', 'filter_model', 'filter_os', 'filter_serial', 'filter_type', 'filter_tag', 'size', 'page', 'order']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'filter_os' in params:
            query_params.append(('filter_os', params['filter_os']))
        if 'filter_serial' in params:
            query_params.append(('filter_serial', params['filter_serial']))
    ...
    def update_device_template(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_device_template_with_http_info(id, **kwargs)
        else:
            (data) = self.update_device_template_with_http_info(id, **kwargs)
            return data
    ...
    def update_device_template_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'device_template_resource']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_device_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_device_template`")
        ...
        return self.api_client.call_api('/devices/templates/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
