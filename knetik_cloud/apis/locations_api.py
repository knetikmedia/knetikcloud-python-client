...
class LocationsApi(object):
    ...
    def get_country_states(self, country_code_iso3, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_country_states(country_code_iso3, callback=callback_function)
    ...
    def get_country_states_with_http_info(self, country_code_iso3, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_country_states_with_http_info(country_code_iso3, callback=callback_function)
