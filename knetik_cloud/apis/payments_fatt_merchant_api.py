...
class PaymentsFattMerchantApi(object):
    """
    ...
    def create_or_update_fatt_merchant_payment_method(self, **kwargs):
        ...
        :param async bool
        :param FattMerchantPaymentMethodRequest request: Request containing payment method information for user
        ...
        if kwargs.get('async'):
            return self.create_or_update_fatt_merchant_payment_method_with_http_info(**kwargs)
        else:
            (data) = self.create_or_update_fatt_merchant_payment_method_with_http_info(**kwargs)
            return data
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_or_update_fatt_merchant_payment_method" % key
                )
            params[key] = val
        del params['kwargs']
