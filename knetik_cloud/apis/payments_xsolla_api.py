...
class PaymentsXsollaApi(object):
    ...
    def receive_xsolla_notification(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.receive_xsolla_notification(async=True)
        >>> result = thread.get()
    ...
    def receive_xsolla_notification_with_http_info(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.receive_xsolla_notification_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api('/payment/provider/xsolla/notifications', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
