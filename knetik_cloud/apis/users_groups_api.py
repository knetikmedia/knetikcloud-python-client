...
class UsersGroupsApi(object):
    ...
    def add_member_to_group(self, unique_name, username, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_member_to_group(unique_name, username, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.add_member_to_group_with_http_info(unique_name, username, **kwargs)
        else:
            (data) = self.add_member_to_group_with_http_info(unique_name, username, **kwargs)
            return data

    def add_member_to_group_with_http_info(self, unique_name, username, **kwargs):
        """
        Adds a new member to the group
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_member_to_group_with_http_info(unique_name, username, callback=callback_function)
        ...
        if ('username' not in params) or (params['username'] is None):
            raise ValueError("Missing the required parameter `username` when calling `add_member_to_group`")
    ...
    def update_groups(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str filter_name: Filter for groups whose name starts with provided string
        :param str filter_unique_name: Filter for groups whose unique_name starts with provided string
        :param str filter_parent: Filter for groups whose parent equals provided string
        :param int size: The number of objects returned per page
        :param int page: The number of the page returned, starting with 1
        :param str order: A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
    ...
    def update_groups_with_http_info(self, **kwargs):
        ...
        all_params = ['filter_name', 'filter_unique_name', 'filter_parent', 'size', 'page', 'order']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
