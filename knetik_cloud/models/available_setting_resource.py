...
class AvailableSettingResource(object):
    ...
    def __init__(self, advanced_option=None, default_value=None, description=None, key=None, name=None, options=None, type=None):
        """
        AvailableSettingResource - a model defined in Swagger
        """

        self._advanced_option = None
    ...
    def type(self):
        """
        Gets the type of this AvailableSettingResource.
        The type of the setting value: Ex: TEXT

        :return: The type of this AvailableSettingResource.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this AvailableSettingResource.
        The type of the setting value: Ex: TEXT

        :param type: The type of this AvailableSettingResource.
        :type: str
        """
        if type is None:
