...
class CoreChallengeActivitySettings(object):
    """
    ...
    def __init__(self, boot_in_play=None, custom_launch_address=None, custom_launch_address_allowed=None, host_option=None, host_status_control=None, join_in_play=None, leave_in_play=None, max_players=None, min_players=None, results_trust=None):
        """
        CoreChallengeActivitySettings - a model defined in Swagger
        """
    ...
    def boot_in_play(self):
        """
        Gets the boot_in_play of this CoreChallengeActivitySettings.
        Whether the host can boot a user while the status is PLAYING. Null to inherit from activity

        :return: The boot_in_play of this CoreChallengeActivitySettings.
        :rtype: bool
        """
    ...
    def boot_in_play(self, boot_in_play):
        """
        Sets the boot_in_play of this CoreChallengeActivitySettings.
        Whether the host can boot a user while the status is PLAYING. Null to inherit from activity

        :param boot_in_play: The boot_in_play of this CoreChallengeActivitySettings.
        :type: bool
        """
    ...
    def custom_launch_address(self):
        """
        Gets the custom_launch_address of this CoreChallengeActivitySettings.
        ...
        :return: The custom_launch_address of this CoreChallengeActivitySettings.
        :rtype: str
        """
    ...
    def custom_launch_address(self, custom_launch_address):
        """
        Sets the custom_launch_address of this CoreChallengeActivitySettings.
        A custom address (url, ip or whatever is needed in your game) that users should connect to to play in this challenge rather than the usual game server. Max length: 255

        :param custom_launch_address: The custom_launch_address of this CoreChallengeActivitySettings.
        :type: str
        """
    ...
    def custom_launch_address_allowed(self):
        """
        Gets the custom_launch_address_allowed of this CoreChallengeActivitySettings.
        ...
        :return: The custom_launch_address_allowed of this CoreChallengeActivitySettings.
        :rtype: bool
        """
    ...
    def custom_launch_address_allowed(self, custom_launch_address_allowed):
        """
        Sets the custom_launch_address_allowed of this CoreChallengeActivitySettings.
        Restriction for whether the host creating an occurrence can specify a custom launch address (such as their own ip address). Will override the challenge's custom_launch_address if they do. Null to inherit from activity

        :param custom_launch_address_allowed: The custom_launch_address_allowed of this CoreChallengeActivitySettings.
        :type: bool
        """
    ...
    def host_option(self):
        """
        Gets the host_option of this CoreChallengeActivitySettings.
        ...
        :return: The host_option of this CoreChallengeActivitySettings.
        :rtype: str
        """
    ...
    def host_option(self, host_option):
        """
        Sets the host_option of this CoreChallengeActivitySettings.
        Restriction for who can host an occurrence. admin disallows regular users, player means the user must also be a player in the occurrence if not admin, non-player means the user has the option to host without being a player. Null to inherit

        :param host_option: The host_option of this CoreChallengeActivitySettings.
        :type: str
        """
    ...
    def host_status_control(self):
        """
        Gets the host_status_control of this CoreChallengeActivitySettings.
        ...
        :return: The host_status_control of this CoreChallengeActivitySettings.
        :rtype: bool
        """
    ...
    def host_status_control(self, host_status_control):
        """
        Sets the host_status_control of this CoreChallengeActivitySettings.
        Restriction for whether the host has control of the status once the game launches. If false they can only manage the game before (when setup and open). Max length: 255. Null to inherit from activity

        :param host_status_control: The host_status_control of this CoreChallengeActivitySettings.
        :type: bool
        """
    ...
    def join_in_play(self):
        """
        Gets the join_in_play of this CoreChallengeActivitySettings.
        Whether users can join while the status is PLAYING. Null to inherit from activity

        :return: The join_in_play of this CoreChallengeActivitySettings.
        :rtype: bool
        """
    ...
    def join_in_play(self, join_in_play):
        """
        Sets the join_in_play of this CoreChallengeActivitySettings.
        Whether users can join while the status is PLAYING. Null to inherit from activity

        :param join_in_play: The join_in_play of this CoreChallengeActivitySettings.
        :type: bool
        """
    ...
    def leave_in_play(self):
        """
        Gets the leave_in_play of this CoreChallengeActivitySettings.
        Whether users can leave while the status is PLAYING. Null to inherit from activity

        :return: The leave_in_play of this CoreChallengeActivitySettings.
        :rtype: bool
        """
    ...
    def leave_in_play(self, leave_in_play):
        """
        Sets the leave_in_play of this CoreChallengeActivitySettings.
        Whether users can leave while the status is PLAYING. Null to inherit from activity

        :param leave_in_play: The leave_in_play of this CoreChallengeActivitySettings.
        :type: bool
        """
    ...
    def max_players(self):
        """
        Gets the max_players of this CoreChallengeActivitySettings.
        The maximum number of players the game can hold. Null to inherit from activity

        :return: The max_players of this CoreChallengeActivitySettings.
        :rtype: int
        """
    ...
    def max_players(self, max_players):
        """
        Sets the max_players of this CoreChallengeActivitySettings.
        The maximum number of players the game can hold. Null to inherit from activity

        :param max_players: The max_players of this CoreChallengeActivitySettings.
        :type: int
        """
    ...
    def min_players(self):
        """
        Gets the min_players of this CoreChallengeActivitySettings.
        The minimum number of players the game can hold. Null to inherit from activity

        :return: The min_players of this CoreChallengeActivitySettings.
        :rtype: int
        """
    ...
    def min_players(self, min_players):
        """
        Sets the min_players of this CoreChallengeActivitySettings.
        The minimum number of players the game can hold. Null to inherit from activity

        :param min_players: The min_players of this CoreChallengeActivitySettings.
        :type: int
        """
    ...
    def results_trust(self):
        """
        Gets the results_trust of this CoreChallengeActivitySettings.
        ...
        :return: The results_trust of this CoreChallengeActivitySettings.
        :rtype: str
        """
    ...
    def results_trust(self, results_trust):
        """
        Sets the results_trust of this CoreChallengeActivitySettings.
        Restriction for who is able to report game end and results. Admin is always able to send results as well. Null to inherit from activity

        :param results_trust: The results_trust of this CoreChallengeActivitySettings.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CoreChallengeActivitySettings):
            return False
