...
class CouponItem(object):
    ...
    """
    def __init__(self, additional_properties=None, behaviors=None, category=None, created_date=None, id=None, long_description=None, name=None, short_description=None, sort=None, tags=None, template=None, type_hint=None, unique_key=None, updated_date=None, displayable=None, geo_country_list=None, geo_policy_type=None, shipping_tier=None, skus=None, store_end=None, store_start=None, vendor_id=None, coupon_type_hint=None, discount_max=None, discount_min_cart_value=None, discount_type=None, discount_value=None, exclusive=None, item_id=None, max_quantity=None, self_exclusive=None, valid_for_tags=None):
        """
