...
class LevelingResource(object):
    ...
    def __init__(self, additional_properties=None, created_date=None, description=None, name=None, tiers=None, trigger_event_name=None, updated_date=None):
        """
    ...
    def trigger_event_name(self):
        """
        Gets the trigger_event_name of this LevelingResource.
        The name of an event that will add one progress to this level when fired

        :return: The trigger_event_name of this LevelingResource.
        :rtype: str
        """
    ...
    def trigger_event_name(self, trigger_event_name):
        """
        Sets the trigger_event_name of this LevelingResource.
        The name of an event that will add one progress to this level when fired

        :param trigger_event_name: The trigger_event_name of this LevelingResource.
        :type: str
        """
