...
class LimitedGettable(object):
    ...
    def group(self):
        """
        Gets the group of this LimitedGettable.

        :return: The group of this LimitedGettable.
        :rtype: LimitedGettableGroup
        """
        return self._group
    ...
    def group(self, group):
        """
        Sets the group of this LimitedGettable.

        :param group: The group of this LimitedGettable.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LimitedGettable):
            return False
