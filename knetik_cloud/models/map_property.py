...
class MapProperty(object):
    ...
    def __init__(self, map=None):
        """
        MapProperty - a model defined in Swagger
        """
    ...
    def map(self):
        """
        Gets the map of this MapProperty.
        A map/object of string to sub-property

        :return: The map of this MapProperty.
    ...
    def map(self, map):
        """
        Sets the map of this MapProperty.
        A map/object of string to sub-property

        :param map: The map of this MapProperty.
