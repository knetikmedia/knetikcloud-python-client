...
class TierResource(object):
    ...
    def __init__(self, additional_properties=None, name=None, required_progress=None, trigger_event_name=None):
        """
    ...
    def trigger_event_name(self):
        """
        Gets the trigger_event_name of this TierResource.
        The name of the triggered event

        :return: The trigger_event_name of this TierResource.
        :rtype: str
        """
    ...
    def trigger_event_name(self, trigger_event_name):
        """
        Sets the trigger_event_name of this TierResource.
        The name of the triggered event

        :param trigger_event_name: The trigger_event_name of this TierResource.
        :type: str
        """
