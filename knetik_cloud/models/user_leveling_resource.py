...
class UserLevelingResource(object):
    ...
    def __init__(self, last_tier_name=None, last_tier_progress=None, level_name=None, next_tier_name=None, next_tier_progress=None, progress=None, tier_names=None, user_id=None):
        ...
        self._last_tier_name = None
        self._last_tier_progress = None
        self._level_name = None
        self._next_tier_name = None
        self._next_tier_progress = None
        self._progress = None
        ...
        self.next_tier_progress = next_tier_progress
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UserLevelingResource):
            return False
