...
class GamificationAchievementsApi(object):
    ...
    def get_achievements_using_get_with_http_info(self, **kwargs):
        ...
        all_params = ['filter_tagset', 'filter_name', 'filter_hidden', 'size', 'page', 'order']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_all_user_progress_for_achievement_using_get_with_http_info(self, achievement_name, **kwargs):
        ...
        all_params = ['achievement_name', 'filter_achievement_tagset', 'filter_achievement_hidden', 'size', 'page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PageUserAchievementResource',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_all_user_progress_using_get_with_http_info(self, **kwargs):
        ...
        all_params = ['filter_achievement_tagset', 'filter_achievement_name', 'filter_achievement_hidden', 'size', 'page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_user_progress_for_achievement_using_get_with_http_info(self, user_id, achievement_name, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='UserAchievementResource',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_user_progress_using_get_with_http_info(self, user_id, **kwargs):
        ...
        all_params = ['user_id', 'filter_achievement_tagset', 'filter_achievement_name', 'filter_achievement_hidden', 'size', 'page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
