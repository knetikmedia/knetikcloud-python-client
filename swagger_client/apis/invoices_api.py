...
class InvoicesApi(object):
    ...
    def list_ful_fillment_statuses(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_ful_fillment_statuses(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_ful_fillment_statuses_with_http_info(**kwargs)
        else:
            (data) = self.list_ful_fillment_statuses_with_http_info(**kwargs)
            return data

    def list_ful_fillment_statuses_with_http_info(self, **kwargs):
        """
        Lists available fulfillment statuses
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_ful_fillment_statuses_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_ful_fillment_statuses" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def list_payment_statuses(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_payment_statuses(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_payment_statuses_with_http_info(**kwargs)
        else:
            (data) = self.list_payment_statuses_with_http_info(**kwargs)
            return data

    def list_payment_statuses_with_http_info(self, **kwargs):
        """
        Lists available payment statuses
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_payment_statuses_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_payment_statuses" % key
                )
            params[key] = val
        del params['kwargs']
