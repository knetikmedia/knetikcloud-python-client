...
class MediaVideosApi(object):
    ...
    def delete_relationship_using_delete1(self, video_id, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_relationship_using_delete1(video_id, id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_relationship_using_delete1_with_http_info(video_id, id, **kwargs)
        else:
            (data) = self.delete_relationship_using_delete1_with_http_info(video_id, id, **kwargs)
            return data

    def delete_relationship_using_delete1_with_http_info(self, video_id, id, **kwargs):
        """
        Delete a video's relationship
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_relationship_using_delete1_with_http_info(video_id, id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_relationship_using_delete1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'video_id' is set
        if ('video_id' not in params) or (params['video_id'] is None):
            raise ValueError("Missing the required parameter `video_id` when calling `delete_relationship_using_delete1`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_relationship_using_delete1`")
    ...
    def update_relationship_using_put1(self, video_id, relationship_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_relationship_using_put1(video_id, relationship_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_relationship_using_put1_with_http_info(video_id, relationship_id, **kwargs)
        else:
            (data) = self.update_relationship_using_put1_with_http_info(video_id, relationship_id, **kwargs)
            return data

    def update_relationship_using_put1_with_http_info(self, video_id, relationship_id, **kwargs):
        """
        Update a video's relationship details
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_relationship_using_put1_with_http_info(video_id, relationship_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_relationship_using_put1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'video_id' is set
        if ('video_id' not in params) or (params['video_id'] is None):
            raise ValueError("Missing the required parameter `video_id` when calling `update_relationship_using_put1`")
        # verify the required parameter 'relationship_id' is set
        if ('relationship_id' not in params) or (params['relationship_id'] is None):
            raise ValueError("Missing the required parameter `relationship_id` when calling `update_relationship_using_put1`")
