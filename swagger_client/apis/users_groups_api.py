...
class UsersGroupsApi(object):
    ...
    def delete_group_using_delete(self, unique_name, user_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_group_using_delete(unique_name, user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_group_using_delete_with_http_info(unique_name, user_id, **kwargs)
        else:
            (data) = self.delete_group_using_delete_with_http_info(unique_name, user_id, **kwargs)
            return data

    def delete_group_using_delete_with_http_info(self, unique_name, user_id, **kwargs):
        """
        Removes a user from a group
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_group_using_delete_with_http_info(unique_name, user_id, callback=callback_function)
        ...
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `delete_group_using_delete`")
    ...
    def delete_group_using_delete1(self, unique_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_group_using_delete1(unique_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_group_using_delete1_with_http_info(unique_name, **kwargs)
        else:
            (data) = self.delete_group_using_delete1_with_http_info(unique_name, **kwargs)
            return data

    def delete_group_using_delete1_with_http_info(self, unique_name, **kwargs):
        """
        Removes a group from the system IF no resources are attached to it
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_group_using_delete1_with_http_info(unique_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_group_using_delete1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'unique_name' is set
        if ('unique_name' not in params) or (params['unique_name'] is None):
            raise ValueError("Missing the required parameter `unique_name` when calling `delete_group_using_delete1`")
    ...
    def search_groups_using_get_with_http_info(self, unique_name, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PageGroupMemberResource',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def search_groups_using_get1_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PageGroupResource',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
