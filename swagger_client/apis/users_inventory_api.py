...
class UsersInventoryApi(object):
    ...
    def grant_entitlement_using_post(self, user_id, grant_request, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.grant_entitlement_using_post(user_id, grant_request, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.grant_entitlement_using_post_with_http_info(user_id, grant_request, **kwargs)
        else:
            (data) = self.grant_entitlement_using_post_with_http_info(user_id, grant_request, **kwargs)
            return data

    def grant_entitlement_using_post_with_http_info(self, user_id, grant_request, **kwargs):
        """
        Grant an entitlement
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.grant_entitlement_using_post_with_http_info(user_id, grant_request, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method grant_entitlement_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `grant_entitlement_using_post`")
        # verify the required parameter 'grant_request' is set
        if ('grant_request' not in params) or (params['grant_request'] is None):
            raise ValueError("Missing the required parameter `grant_request` when calling `grant_entitlement_using_post`")
