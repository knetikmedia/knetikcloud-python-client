...
class UtilMaintenanceApi(object):
    ...
    def delete_maintenance(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_maintenance(callback=callback_function)
    ...
    def delete_maintenance_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_maintenance_with_http_info(callback=callback_function)
    ...
    def get_maintenance(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_maintenance(callback=callback_function)
    ...
    def get_maintenance_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_maintenance_with_http_info(callback=callback_function)
    ...
    def update_maintenance(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_maintenance(callback=callback_function)
    ...
    def update_maintenance_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_maintenance_with_http_info(callback=callback_function)
    ...
    def update_maintenance1(self, **kwargs):
        """
        Set current maintenance info
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_maintenance1(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_maintenance1_with_http_info(**kwargs)
        else:
            (data) = self.update_maintenance1_with_http_info(**kwargs)
            return data

    def update_maintenance1_with_http_info(self, **kwargs):
        """
        Set current maintenance info
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_maintenance1_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_maintenance1" % key
                )
            params[key] = val
        del params['kwargs']
