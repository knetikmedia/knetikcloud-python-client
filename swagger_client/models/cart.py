...
class Cart(object):
    ...
    """
    def __init__(self, country_tax=None, coupons=None, created=None, currency_code=None, discount_total=None, error_code=None, error_message=None, grand_total=None, id=None, invoice_id=None, items=None, owner=None, selected_shipping_options=None, shippable=None, shipping_address=None, shipping_cost=None, shipping_options=None, state_tax=None, status=None, subtotal=None, updated=None):
        """
    ...
    def shipping_options(self):
        """
        Gets the shipping_options of this Cart.

        :return: The shipping_options of this Cart.
        :rtype: dict(str, Set)
        """
    ...
    def shipping_options(self, shipping_options):
        """
        Sets the shipping_options of this Cart.

        :param shipping_options: The shipping_options of this Cart.
        :type: dict(str, Set)
        """
