...
class CouponItem(object):
    ...
    """
    def __init__(self, additional_properties=None, behaviors=None, category=None, coupon_type_hint=None, created_date=None, discount_max=None, discount_min_cart_value=None, discount_type=None, discount_value=None, displayable=None, exclusive=None, geo_country_list=None, geo_policy_type=None, id=None, item_id=None, long_description=None, max_quantity=None, name=None, self_exclusive=None, shipping_tier=None, short_description=None, skus=None, sort=None, store_end=None, store_start=None, tags=None, template=None, type_hint=None, unique_key=None, updated_date=None, valid_for_tags=None, vendor_id=None):
        """
