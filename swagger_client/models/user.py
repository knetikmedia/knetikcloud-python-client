...
class User(object):
    ...
    """
    def __init__(self, additional_properties=None, address=None, address2=None, affiliate=None, avatar_url=None, city=None, country=None, currency=None, date_created=None, date_of_birth=None, date_updated=None, description=None, display_name=None, email=None, first_name=None, fullname=None, gender=None, guest=None, id=None, invite_token=None, lang=None, last_activity=None, last_login=None, last_name=None, lockout_attempts=None, lockout_date=None, mobile_number=None, old_id=None, password=None, postal_code=None, properties_string=None, roles=None, state=None, status=None, template=None, timezone=None, token=None, type_hint=None, username=None):
        """
