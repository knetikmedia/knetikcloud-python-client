...
from knetik_cloud.apis.media_polls_api import MediaPollsApi


class TestMediaPollsApi(unittest.TestCase):
    """ MediaPollsApi unit test stubs """

    def setUp(self):
        self.api = knetik_cloud.apis.media_polls_api.MediaPollsApi()
